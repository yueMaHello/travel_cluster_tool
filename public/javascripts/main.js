...
"dojo/ready","dojo/_base/connect", "dojo/dom", "dojo/on","esri/dijit/BasemapToggle","esri/dijit/Scalebar","esri/geometry/Point","esri/InfoTemplate"],
...
ready, connect,dom, on,BasemapToggle,Scalebar,Point,InfoTemplate)
{ready(function () {
    ...
    function outputGeojson(centroids){
        let geojson = {"name":"NewFeatureType",
    ...
    function addPoint(evt) {
        let number = evt.graphic.attributes.demand || evt.graphic.symbol.demand;
